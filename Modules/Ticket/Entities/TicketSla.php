...
{
    // use SoftDeletes;
    protected $table = 'ticket_support_sla';
    ...
    public static function detail($ticket_id){
		$data = Self::select(['ticket_support_sla.*','a.full_name as user_approve_isp','b.full_name as user_approve_osp','x.*'])
				->join('ticket_support as x','x.ticket_id','=','ticket_support_sla.ticket_id')
				->leftJoin('users as a','a.id','=','ticket_support_sla.accept_isp_by')
				->leftJoin('users as b','b.id','=','ticket_support_sla.accept_osp_by')
