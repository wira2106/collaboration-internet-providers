    ...
    <div class="row page-titles">
      <div class="col-md-5 align-self-center">
        <h3 class="text-themecolor">
          {{ trans("ticketsSla.title.view ticket") }}
        </h3>
      </div>
    ...
    <div class="container" v-loading="loading">
      <div class="row">
        ...
        <accept_sla
          v-if="load_data"
          :data="data"
          @saveAcceptSLA="fetchData(0)"
          @reloadApproveSLA="fetchData(1)"
        />
  ...
  methods: {
    ...
    closeTicketSupport() {
      ...
      if (this.data.accept_isp_by == null) {
        text = this.trans("ticketsSla.messages.sla tidak muncul.isp");
      } else if (this.data.accept_osp_by == null) {
        text = this.trans("ticketsSla.messages.sla tidak muncul.osp");
      }
      Swal.fire({
        title: this.trans("ticketsSla.alert.close ticket"),
        text: text,
        icon: "warning",
        showCancelButton: true,
        confirmButtonColor: "#3085d6",
