...
@section('konten')
    <div>
        ...
        <div style="font-size: 14px">
            <p style="padding-top:15px; margin-left:0.2rem">{{trans('pelanggan::activations.mail.text.approve berhasil')}} :</p>
            <table>
            ...
            {{trans('pelanggan::activations.mail.text.data pelanggan')}}.
            </p>
        </div>
    </div>
@endsection
