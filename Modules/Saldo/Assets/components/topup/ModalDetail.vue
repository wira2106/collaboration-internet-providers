    ...
    <div class="modal-body" v-loading="modalLoading">
      <div class="row">
                  ...
                  <table class="table">
                    <tr>
                      <td style="font-size: 14px;">
                        {{ trans("saldos.form.tgl transfer") }}
                      </td>
                      <td>
        ...
        <div class="col-md-10" v-if="batal">
          <el-form ref="alasan" :model="konfirmasi">
            <el-form-item
              :label="trans('saldos.form.alasan')"
              prop="keterangan"
              :rules="[
                {
                  required: true,
          ...
          <div class="col-md-12 text-center pt-2">
            <el-button
              ...
              >{{ trans("saldos.button.simpan") }}</el-button
            >
          </div>
        </div>
      </div>
...
export default {
  ...
  methods: {
    ...
    confirm(cancel = true) {
      Swal.fire({
        title: cancel
          ? this.trans("topups.messages.cancel topup")
          : this.trans("topups.messages.confirm topup"),
        text: "",
        icon: "warning",
        ...
        if (result.value) {
          ...
          this.form
            .post(route("api.saldo.topup.update"))
            .then((response) => {
              this.Toast({
                icon: "success",
