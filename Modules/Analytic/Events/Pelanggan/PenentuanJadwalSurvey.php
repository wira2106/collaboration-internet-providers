...
class PenentuanJadwalSurvey
{
     ...
     * @return array
     */
    public function penentuanJadwalSurvey()
    {
        $pelanggan_id = $this->pelanggan_id;
        $pelanggan = Pelanggan::find($pelanggan_id);
        $company_id = $pelanggan->isp_id;
        // start time
        $created_at = $this->getCreatedAtFromPengajuanSurvey($pelanggan_id);
    ...
    public function getCreatedAtFromPengajuanSurvey($pelanggan_id)
    {
        $pengajuan = DB::table('tanggal_pengajuan_survey as a')->select('a.created_at')
