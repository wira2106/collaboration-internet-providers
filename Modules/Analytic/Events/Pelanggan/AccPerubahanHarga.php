...
class AccPerubahanHarga
{
    ...
    public function accPerubahanHarga()
    {
        ...
        // start time
        $created_at = $this->getTanggalPengajuanHarga($pelanggan_id);
    ...
    public function getTanggalPengajuanHarga($pelanggan_id)
    {
        $data = DB::table('perubahan_harga')->where('pelanggan_id',$pelanggan_id)->orderby('perubahan_harga_id','desc')->first();
