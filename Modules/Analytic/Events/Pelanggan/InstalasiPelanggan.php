...
class InstalasiPelanggan
{
     ...
     * @return array
     */
    public function instalasiPelanggan()
    {
        $pelanggan_id = $this->pelanggan_id;
        $pelanggan = Pelanggan::find($pelanggan_id);
        $company_id = $pelanggan->osp_id;
        // start time
        $created_at = $this->getTanggalInstalasi($pelanggan_id);
    ...
    public function getTanggalInstalasi($pelanggan_id)
    {
        $instalasi = DB::table('instalasi')->where('pelanggan_id',$pelanggan_id)->first();
        
        return $instalasi->tgl_instalasi." ".$instalasi->jam_start;
    }
}
