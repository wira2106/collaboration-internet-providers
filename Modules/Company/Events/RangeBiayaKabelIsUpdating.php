...
class RangeBiayaKabelIsUpdating extends AbstractEntityHook implements EntityIsChanging
{
    ...
    public function check_data() {
        ...
        $biaya_kabel = RangeBiayaKabel::where('biaya_kabel_id', $this->biaya_kabel->biaya_kabel_id)
