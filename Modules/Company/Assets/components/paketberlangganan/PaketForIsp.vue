      ...
      <div class="col-md-12">
        <div class="btn-group pull-left" style="margin: 0 15px 15px 0">
          <router-link :to="{ name: 'admin.company.paketforisp.create' }">
            <el-tooltip
              :content="trans('core.tooltip.paket.tambah')"
              placement="top"
            >
              <el-button type="primary" size="small">
                <i class="fa fa-edit"></i>
                {{
                  trans("paketberlangganans.button.create paketberlangganan")
                }}
              </el-button>
            </el-tooltip>
          </router-link>
    ...
    <div class="row">
      <div class="col-md-12">
        ...
        >
          ...
          <el-table-column
            prop="name"
            :label="trans('paketberlangganans.table.nama company')"
            sortable="custom"
          >
            <template slot-scope="scope">
          ...
          <el-table-column
            ...
            sortable="custom"
          >
            <template slot-scope="scope"> {{ scope.row.sla }} % </template>
          </el-table-column>
