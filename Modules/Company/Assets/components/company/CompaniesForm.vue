          ...
          <div class="col-md-12">
            ...
            <div class="card card-outline-info">
              ...
              <div class="card-footer">
                <el-form-item>
                  <el-button type="danger" @click="onCancel()" v-if="canIndexCompany"
                  ...
                  <el-button
                    ...
                    icon="el-icon-upload"
                  >
                    {{ (company.company_id != null ? trans("companies.button.update company"):trans("companies.button.save company"))}}
                  </el-button>
                </el-form-item>
              </div>
            </div>
  ...
  methods: {
    ...
    beforeAvatarUpload(file) {
      ...
      if (!isJPG) {
        this.Toast({
          icon: "error",
          title: this.trans("companies.messages.picture error format"),
        });
      }
      if (!isLt2M) {
        this.Toast({
          icon: "error",
          title: this.trans("companies.messages.picture error size"),
        });
      }
