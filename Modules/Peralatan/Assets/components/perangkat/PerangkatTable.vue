            ...
            <div class="card-body">
              <div class="row">
                <div class="col-md-12">
                  ...
                  >
                    <router-link
                      :to="{ name: 'admin.peralatan.perangkat.create' }"
                    >
                      <el-button type="primary">
                        <i class="fa fa-edit"></i>
                        {{ trans("perangkats.button.create perangkat") }}
                      </el-button>
                    </router-link>
                  </div>
                  <div
              ...
              <div class="row">
                <div class="col-md-12">
                  ...
                  >
                    ...
                    <el-table-column
                      prop="nama_perangkat"
                      :label="trans('perangkats.table.nama perangkat')"
                      sortable="custom"
                    >
                    ...
                    <el-table-column
                      prop="created_at"
                      :label="trans('perangkats.table.created')"
                      sortable="custom"
                    >
                      <template slot-scope="scope">
                    ...
                    <el-table-column
                      prop="updated_at"
                      :label="trans('perangkats.table.updated')"
                      sortable="custom"
                    >
                      <template slot-scope="scope">
                    ...
                    <el-table-column
                      prop="actions"
                      :label="trans('perangkats.table.action')"
                      sortable="custom"
                    >
                      <template slot-scope="scope">
                        <el-button-group>
                          <el-tooltip
                            class="item"
                            effect="dark"
                            :content="trans('perangkats.tooltip.button.edit')"
                            placement="top"
                          >
                            <edit-button
                              :to="{
                                name: 'admin.peralatan.perangkat.edit',
                                params: { perangkat: scope.row.perangkat_id },
                              }"
                            ></edit-button>
                          </el-tooltip>
                          <el-tooltip
                            class="item"
                            effect="dark"
                            :content="trans('perangkats.tooltip.button.hapus')"
                            placement="top"
                          >
                            <delete-button
                              :scope="scope"
