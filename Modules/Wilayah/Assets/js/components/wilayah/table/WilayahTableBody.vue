<template>
  <div class="sc-table">
    ...
    >
      ...
      <el-table-column
        :label="trans('pengajuans.table.open.status')"
        width="80"
      >
        <template slot-scope="scope">
          <i
      ...
      <el-table-column prop="actions" :label="trans('core.table.actions')">
        <template slot-scope="scope">
          <el-button-group>
            <el-tooltip
              :content="trans('core.tooltip.wilayah.maker')"
              placement="top"
            >
              <el-button
                size="mini"
            ...
            <el-tooltip
              :content="trans('core.tooltip.wilayah.hapus')"
              placement="top"
            >
              <delete-button
                :scope="scope"
            ...
            <el-tooltip
              :content="trans('core.tooltip.wilayah.presale')"
              placement="top"
            >
              <el-button
                type="warning"
