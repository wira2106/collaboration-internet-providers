                ...
                <div class="row">
                  <div class="col-md-12">
                    <el-form-item
                      ...
                      :class="{
                        'el-form-item is-error': form.errors.has('full_name'),
                      }"
                      prop="full_name"
                      :rules="[
                        {
                  ...
                  <div class="col-md-12">
                    <el-form-item
                      :label="trans('staff.form.user_picture')"
                      :class="{
                  ...
                  <div class="col-md-12" v-show="staffForm.user_id != null">
                    <el-checkbox v-model="ubahPasswordCheck">{{
                      trans("staff.title.ubah password")
                    }}</el-checkbox>
                  </div>
                  <div class="col-md-12" v-if="ubahPasswordCheck">
                    <div class="row">
                      <div class="col-md-12">
                        <el-form-item
              ...
              <div class="card-footer">
                <el-form-item>
                  <el-button
                    ...
                    icon="el-icon-upload"
                  >
                    {{ (staffForm.user_id == null?trans("staff.button.save user"):trans("staff.button.update user")) }}
                  </el-button>
                  <el-button type="danger" @click="onCancel('staffForm')">
  ...
  methods: {
    ...
    fetchStaff() {
      ...
      if (this.$route.params.staff !== undefined) {
        ...
        routeUri = route("api.user.staff.find", {
          staff: this.$route.params.staff,
        });
        axios
          .post(routeUri)
          .then((response) => {
