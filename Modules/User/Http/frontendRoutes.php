...
$router->group(['prefix' => 'auth'], function (Router $router) {
    ...
    $router->get('reset_password/{id}/{code}', ['as' => 'resetpassword.complete', 'uses' => 'AuthController@getResetPasswordComplete']);
    $router->post('reset_password/{id}/{code}', ['as' => 'resetpassword.complete.post', 'uses' => 'AuthController@postResetPasswordComplete']);
    # Logout
