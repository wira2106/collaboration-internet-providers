                        ...
                        <div class="col-md-8">
                                ...
                                style="margin-top: 15px;">
                                    <div class="card-header text-white">
                                        ...
                                        <el-button v-if="index > 0 && !$route.params.alat" style="float: right; padding: 3px 0; text-decoration:none;" type="text" @click="removeInput(barang)">
                                    ...
                                    <div class="card-body">
                                        ...
                                        :rules="{required: true, 
                                                  message:trans('core.validation.required',{field:trans('barangs.form.name')}),
                                                  trigger:'blur'}">
                                            <el-input v-model="barang.nama_barang" :placeholder="trans('barangs.placeholder.nama')"></el-input>
                                        </el-form-item>
                                        <el-form-item 
                                        :label="trans('barangs.form.type')"
                                        :prop="'barang.'+index+'.tipe_qty'" 
                                        :rules="{required: true, 
                                                message:trans('core.validation.required',{field:trans('barangs.form.type')}),
                                                trigger:'blur'}">
                                            <el-select v-model="barang.tipe_qty">
                                                <el-option v-for="option in options" :value="option.value" :key="option.value">
                                                    {{option.text}}
                                                </el-option>
                                            </el-select>
                                        </el-form-item>
                                        ...
                                        :rules="{required: true, 
                                                message:trans('core.validation.required',{field:trans('barangs.form.price')}),
                                                trigger:'blur'}">
                                            <InputCurrency v-model="barang.harga_per_pcs" :placeholder="trans('barangs.placeholder.harga')">
                                            </InputCurrency>
                                        </el-form-item>
                                    </div>
                                </div>
                                <div class="card">
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <el-button class="pull-left" type="primary" @click="onSubmit()">{{ trans('core.save') }}</el-button>
                                                <el-button class="pull-left" type="danger" @click="$router.go(-1)">{{ trans('core.button.cancel')}}</el-button>
                                            </div>
                                            <div class="col-md-6">
                                                <el-button v-if="!$route.params.barang" type="primary" class="pull-right" @click="addInput">
                ...
                if (params !== undefined) {
                    ...
                    axios.get(routeUrl).then((response)=>{
                        if (response.data) {
                            ...
                            this.barangForm.barang[0].harga_per_pcs = response.data.harga_per_pcs;
