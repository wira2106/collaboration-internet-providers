<template>
  <div>
      ...
      >
        ...
        <el-table-column width="60">
          <template slot-scope="scope">
            <span class="span-new" v-if="scope.row.status_survey == null"
              >New</span
            >
            <i
            ...
            <i
              ...
              v-if="
                scope.row.status_survey == 'active' && scope.row.cancel != 1
              "
            ></i>
          </template>
        </el-table-column>
    ...
    <div class="container mt-2 text-small">
      <span class="span-new">New</span> &nbsp;Baru &nbsp;
      <i class="fas fa-circle text-info"></i> &nbsp;Active &nbsp;
