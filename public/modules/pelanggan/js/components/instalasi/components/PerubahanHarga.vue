          ...
          <div class="modal-body">
            ...
            >
              ...
              <tr>
                ...
                <td width="5%">:</td>
                <td v-show="Histori.status == null" width="30%">Diajukan</td>
                <td v-show="Histori.status != null" width="30%">
                  {{ Histori.status }}
                </td>
              </tr>
            </table>
        ...
        <div class="modal-content" v-loading="modalLoading">
          ...
          <div class="modal-footer">
            <el-button
              ...
              :disabled="user_profile.id == idPengaju"
              data-dismiss="modal"
              type="primary"
              @click="SetTerima"
              >{{ trans("pelangganinstalasi.terima") }}</el-button
            >
            <el-button
              size="small"
              :hidden="ajukanUlang == true"
              ...
              @click="SetTolak"
              type="danger"
              >{{ trans("pelangganinstalasi.tolak") }}</el-button
            >
            <el-button
              size="small"
              type="primary"
            ...
            <el-button
              ...
              data-dismiss="modal"
              type="danger"
              >{{ trans("pelangganinstalasi.batal") }}</el-button
            >
          </div>
        </div>
      </div>
