<template>
  <div class="card card-outline-info mb-4" v-loading="loading">
    ...
    <div class="card-body container">
      <div class="row mt-4">
        <div class="col-md-6">
          <table>
            <tr>
              <td width="200px" style="font-width: 10px">
            ...
            <tr>
              ...
              <td>
                <span>
                  <span>{{ DataPelangganInstalasi.foto_identitas }}</span>
      ...
      <div>
        <el-button
          type="primary"
          v-show="status == 1 && ajukanUlang == true"
          plain
          size="small"
