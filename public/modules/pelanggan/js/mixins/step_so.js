        ...
        input_email: [
          {
            ...
            type: "email",
            trigger: ["blur"],
            message: this.trans("core.validation.email"),
          },
          {
            type: "email",
          },
      ...
      axios
        ...
        .then((response) => {
          let data = response.data.data;
            this.form = {...data, osp_id:response.data.osp};
            this.mapInfo = data;
            ...
            this.loading = false;
            this.form.biaya_mrc_with_format = response.data.data.biaya_mrc_with_format;
            this.form.biaya_otc_with_format = response.data.data.biaya_otc_with_format;
            this.status_pelanggan = response.data.status_pelanggan;
            if (response.data.data.status_pelanggan !== 'so' && response.data.data.status_pelanggan !== null) {
              this.finishSO = true;
            }
            let paket  = response.data.paket.find(paket => paket.paket_id === this.form.paket_id);
