<template>
  <el-select filterable v-on:change="handleChange" v-bind:value="value" :ref="reference" :placeholder="trans('perangkats.placeholder.pilih perangkat')" size="small">
    <el-option
          ...
          if (typeof result.value !== 'undefined') {
            ...
            if(value == ""){
              ...
              if(sendValue != null){
                ...
                axios.post(route('api.peralatan.perangkat.store'),{nama_perangkat:value})
                .then((response) => {
                  this.perangkats.push({perangkat_id : response.data.id, nama_perangkat : value});
