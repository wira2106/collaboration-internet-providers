<template>
  <bs-modal id="modal-add-presale" size="large" @onClose="onCancel()">
    ...
    <div class="container">
      ...
      >
        <div class="row">
          ...
          <div class="col-12">
            <p style="font-size:10pt;text-align:center">{{presale.edited_text}}</p>
          </div>
          <el-divider>
          </el-divider>

          <div class="col-12 col-md-6">
            <el-form-item :label="trans('presales.form.lat')"
                    prop="lat">
          ...
          <div class="col-12 col-md-6">
            <el-form-item :label="trans('presales.form.lon')"
                    prop="lon">
          ...
          <div class="col-12 col-md-6">
            <el-form-item :label="trans('presales.form.end_point_name')"
                    prop="end_point_name">
              <el-input v-model="presale.endpoint_name" size="small" disabled></el-input>
            </el-form-item>
          </div>
          
          <div class="col-12 col-md-6">
            <el-form-item :label="trans('presales.form.panjang_kabel')"
                    prop="panjang_kabel">
              <el-input type="number" min="0" v-model="presale.panjang_kabel" size="small" @keyup.native="handleChangePanjangKabel"></el-input>
            </el-form-item>
          </div>

          <div class="col-12 col-md-12">
            <el-form-item :label="trans('presales.form.biaya_kabel')"
                    prop="biaya_kabel">
              <input-currency
              v-model="presale.biaya_kabel"
              >
              </input-currency>
            </el-form-item>
          </div>
          ...
          <div class="col-12">
            <el-form-item :label="trans('presales.form.provinces')"
                    prop="provinces_id"
          ...
          <div class="col-12">
            <el-form-item :label="trans('presales.form.regencies')"
                    prop="regencies_id"
                    :rules="rules.regencies_id">
              <SelectRegencies v-model="presale.regencies_id" :provinces_id="presale.provinces_id"></SelectRegencies>
            </el-form-item>
          </div>

          <div class="col-12">
            <el-form-item :label="trans('presales.form.districts')"
                    prop="districts_id"
                    :rules="rules.districts_id">
              <SelectDistricts v-model="presale.districts_id" :regencies_id="presale.regencies_id"></SelectDistricts>
            </el-form-item>
          </div>

          <div class="col-12">
            <el-form-item :label="trans('presales.form.villages')"
                    prop="villages_id"
                    :rules="rules.villages_id">
              <SelectVillages v-model="presale.villages_id" :districts_id="presale.districts_id"></SelectVillages>
            </el-form-item>
          </div>

          <div class="col-12 col-md-4">
            <el-form-item :label="trans('presales.form.nama_gang')"
                    prop="nama_gang">
              <el-input
                v-model="presale.nama_gang"
                size="small">
              </el-input>
          ...
          <div class="col-12 col-md-4">
            <el-form-item :label="trans('presales.form.no_rumah')"
                    prop="no_rumah">
              <el-input
                v-model="presale.no_rumah"
                size="small">
              </el-input>
          ...
          <div class="col-12 col-md-4">
            <el-form-item :label="trans('presales.form.kode_pos')"
                    prop="kode_pos">
              <el-input
                v-model="presale.kode_pos"
                size="small">
              </el-input>
          ...
          <div class="col-12">
            <el-form-item :label="trans('presales.form.address')"
                    prop="address"
                    :rules="rules.address">
              <el-input
                type="textarea"
                :rows="2"
                v-model="presale.address">
              </el-input>
          ...
          <div class="col-12 col-md-6">
            <el-form-item :label="trans('presales.form.class')"
                    prop="class_id"
          ...
          <div class="col-12 col-md-6">
            <el-form-item :label="trans('presales.form.status')"
                    prop="status_id"
          ...
          <div class="col-12">
            <el-form-item :label="trans('presales.form.keterangan')"
                    prop="keterangan"
                    :rules="rules.keterangan">
              <el-input
                type="textarea"
                :rows="2"
                v-model="presale.keterangan">
              </el-input>
    ...
    <div slot="footer">
      <el-button type="primary" @click="onSubmit('presale')" :loading="loading">
          {{ trans('core.save') }}
      </el-button>
...
export default {
      ...
      return {
        ...
        rules: {
          provinces_id:[
            {
              required:true, 
              message: this.trans('core.validation.required', {field:'province'}), 
              trigger:'blur'
            }
          ],
          regencies_id:[
            {
              required:true, 
              message: this.trans('core.validation.required', {field:'regency'}), 
              trigger:'blur'
            }
          ],
          districts_id: [
            {
              required:true, 
              message: this.trans('core.validation.required', {field:'district'}), 
              trigger:'blur'
            }
          ],
          villages_id:[
            {
              required:true, 
              message: this.trans('core.validation.required', {field:'village'}), 
              trigger:'blur'
            }
          ],
          address: [
            {
              required:true, 
              message: this.trans('core.validation.required', {field:'address'}), 
              trigger:'change'
            }
          ],
          foto_rumah:'',
          class_id:[
            {
              required:true, 
              message: this.trans('core.validation.required', {field:'Tipe rumah'}), 
              trigger:'blur'
            }
          ],
          status_id: [
            {
              required:true, 
              message: this.trans('core.validation.required', {field:'status'}), 
              trigger:'blur'
            }
          ]
        },
    ...
    methods: {
                    ...
                    if(valid) {
                      ...
                      if(this.presale_id) {
                        ...
                        properties = {
                          ...
                          pathline: this.convertPolyLineToArray(this.polyline.getPath().getArray()) 
                        }
    
                      }
                      let form = new Form(properties);
                      form.post(this.getRoute())
                      .then(response => {
                        this.loading = false;
                        this.Toast({
                          icon:'success',
      ...
      getRoute() {
        if(this.presale_id) {
          return route('api.presale.presales.update', {presale: this.presale_id})
        }
      ...
      fetchGetDataPresale() {
        axios.get(route('api.presale.presale.show', {presale: this.presale_id}))
        .then(response => {
      ...
      generateBiayaKabel() {
        ...
        let panjang = this.presale.panjang_kabel === '' ? 0 : this.presale.panjang_kabel;
        if(this.data_biaya_kabel.tipe == "precone") {
          this.presale.biaya_kabel = parseInt(this.data_biaya_kabel.precone) * parseInt(panjang); 
        } else {
      ...
      findBiayaKabel(panjang_kabel) {
        ...
        for (var i = 0; i < this.data_biaya_kabel.dropcore.length; i++) {
          if (i != 0) {
            if (panjang_kabel > this.data_biaya_kabel.dropcore[i-1].panjang_kabel && panjang_kabel <= this.data_biaya_kabel.dropcore[i].panjang_kabel) {
              harga_kabel = this.data_biaya_kabel.dropcore[i].biaya;
              break;
            }
          }else if(panjang_kabel <= this.data_biaya_kabel.dropcore[i].panjang_kabel){
            harga_kabel = this.data_biaya_kabel.dropcore[i].biaya;
          } else {
            harga_kabel = this.data_biaya_kabel.dropcore[i].biaya;
          }
    ...
    watch: {
      ...
      polyline: function(val) {
        this.presale.panjang_kabel = Math.round(this.google.maps.geometry.spherical.computeLength(this.polyline.getPath().getArray()));
      },
