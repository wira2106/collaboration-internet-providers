<template>
  <div class="map-wrapper">
    ...
    <button
      ...
      style="position: absolute;bottom: 230px;right: 10px;width: 40px;"
    ...
    <edit-endpoint
      :company_id="company_id"
      :end_point_id="end_point_id"
      @handleSuccess="closeInfowindowGoogle"
    >
    </edit-endpoint>
    <modal-add-presale
          ...
          const { value: keterangan } = await Swal.fire({
            ...
            preConfirm: () => {
              if (
                ...
                if (
                  $(".swal2-popup .pilihanKeterangan:checked").val() ===
                  "lainnya"
                ) {
