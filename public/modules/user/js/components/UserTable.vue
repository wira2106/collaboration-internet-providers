        ...
        <div class="col-md-7 align-self-center">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item">
                    <router-link :to="{name: 'admin.user.users.index'}"> {{ trans('users.title.users') }} </router-link>
                </li>
            </ol>
        </div>
    </div>
            ...
            <div class="card-body">
                <div class="sc-table">
                    <div class="tool-bar row" style="padding-bottom: 20px;">
                        <div class="actions col-12">
                            <router-link :to="{name: 'admin.user.users.create'}">
                                <el-button type="primary" size="small"><i class="el-icon-edit"></i>
                        ...
                        <div class="search col-12 py-2">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <el-select v-if="companies.length > 0" v-model="company.company_id" placeholder="Select" filterable size="small" @change="fetchData">
                    ...
                    <el-table :data="data" stripe style="width: 100%" ref="pageTable" v-loading.body="tableIsLoading" @sort-change="handleSortChange">
                        ...
                        <el-table-column :index="indexMethod" type="index" prop="logo_perusahaan" label="No" sortable="custom" width="75">
                        </el-table-column>
                        <el-table-column prop="full_name" :label="trans('users.table.full-name')" sortable="custom">
                            <template slot-scope="scope">
                        ...
                        <el-table-column prop="phone" :label="trans('users.table.phone')" sortable="custom">
                            <template slot-scope="scope">
                                <a @click.prevent="goToEdit(scope)" href="#">
                                    {{ scope.row.phone }}
                                </a>
...
export default {
    ...
    methods: {
        queryServer(customProperties) {
            ...
            axios.get(route('api.user.user.index', _.merge(properties, customProperties, this.company)))
                .then((response) => {
