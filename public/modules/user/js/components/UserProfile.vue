    ...
    <div>
        <div class="row page-titles">
            ...
            <div class="col-md-7 align-self-center">
                ...
                <li class="breadcrumb-item"><router-link :to="{name: 'admin.user.users.account'}"> {{ trans('users.breadcrumb.edit-profile') }} </router-link> </li>
                 ...
                 @keydown="form.errors.clear($event.target.name);">
                  <div class="card card-outline-info">
                      <div class="card-header">
                          <h5 class="card-title text-white">{{ trans('users.title.edit-profile') }}</h5>
                      </div>
                      <div class="card-body">
                        <div class="row">
                          <div class="col-md-12">
                            <div class="box box-primary">
                              <div class="box-body">
                                <el-tabs>
                                  <el-tab-pane style="padding-top: 10px;" :label="trans('users.tabs.data')">
                                      <span slot="label"
                                            :class="{'error' : form.errors.any()}">
                                          {{ trans('users.tabs.data') }}
                                      </span>
                                      <el-form-item :label="trans('users.form.full-name')"
                                                    :class="{'el-form-item is-error': form.errors.has('full-name') }">
                                      ...
                                      <el-form-item :label="trans('users.form.phone')"
                                          ...
                                          <div class="el-form-item__error" v-if="form.errors.has('phone')" v-text="form.errors.first('phone')"></div>
                                      </el-form-item>
                                      <el-form-item :label="trans('users.form.user_picture')"
                                  ...
                                  <el-tab-pane style="padding-top: 10px;" :label="trans('users.tabs.new password')" v-if="! user.is_new">
    ...
    export default {
        ...
        methods: {
            ...
            validatePass2(rule, value, callback){              
                if(this.user.password_confirmation !== this.user.password) return callback(new Error(this.trans('companies.validation.not match', {field:'password'})))
                return callback()
            },
            ...
            fetchUser() {
                ...
                axios.get(route('api.account.profile.find-current-user'))
                    .then((response) => {
                        ...
                        if (this.user.photo_profile != null && this.user.photo_profile != "") {
