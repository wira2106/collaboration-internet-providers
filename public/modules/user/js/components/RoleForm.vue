        ...
        <div class="row page-titles">
            ...
            <div class="col-md-7 align-self-center">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><router-link :to="{name: 'admin.user.roles.index'}"> {{ trans('roles.title.roles') }} </router-link> </li>
                    <li class="breadcrumb-item"><router-link :to="{name: 'admin.user.roles.create'}"> {{ trans(`roles.${pageTitle}`) }} </router-link> </li>
                </ol>
            </div>            
        </div>
        <el-form ref="form"
                    ...
                    <div class="card-body">
                        <el-tabs>
                            ...
                            <el-tab-pane :label="trans('users.title.users')">
                                ...
                                <ul>
                                    <li v-for="user in role.users" :key="user.id">{{ user.full_name }} ({{ user.email }})</li>
                                </ul>
                            </el-tab-pane>
                        </el-tabs>
                    </div>
