    ...
    <div>
        <div class="row page-titles">
            <div class="col-md-5 align-self-center">
                <h3 class="text-themecolor">  {{ trans('biaya_kabel.title.biaya-kabel') }}</h3>
            </div>
            <div class="col-md-7 align-self-center">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="/backend">{{ trans('core.breadcrumb.home') }}</a></li>
                    <li class="breadcrumb-item">{{ trans('biaya_kabel.title.biaya-kabel') }} </li>
                </ol>
            </div>          
        </div>
        ...
        <div class="container">
            ...
            <div class="card card-outline-info">
                <div class="card-header text-white">
                    ...
                    <el-button v-if="biaya_kabel.tipe === 'dropcore'" plain size="small" icon="el-icon-plus" class="pull-right" @click="goToCreate()">{{trans('biaya_kabel.button.create biaya kabel')}}</el-button>
                </div>
                <div class="card-body">
                    <div class="tool-bar row" style="padding-bottom: 20px;">
                        ...
                        <div class="col-12 mt-2">
                            <div class="col-12" v-if="biaya_kabel.tipe">
                                <el-radio-group v-model="biaya_kabel.tipe" @change="biayaKabelTipeChanged()">
                                    <el-radio 
                    ...
                    <div class="col-12" v-if="biaya_kabel.tipe === 'precone'">
                        <el-form 
                        ref="biaya-kabel"
                        :model="biaya_kabel">
                            <el-form-item
                    ...
                    <el-table
                        ...
                        v-if="biaya_kabel.tipe === 'dropcore'"
                        >
                        ...
                        <el-table-column prop="panjang_kabel"
                        :label="trans('biaya_kabel.form.panjang kabel')" 
                        sortable="custom">
                            <template slot-scope="scope">
                                <a href="#" @click.prevent="gotoEdit(scope)">
                                    {{scope.row.panjang_kabel}}
                                </a>
                            </template>
                        </el-table-column>
                        <el-table-column prop="biaya"
                        ...
                        <el-table-column prop="aksi" :label="trans('core.table.actions')">
                            <template slot-scope="scope">
                                <el-button-group>
                                    ...
                                    <delete-button :scope="scope" :rows="biayakabel" v-on:onDelete="tableIsLoading = $event" v-on:onDeleteSuccess="tableIsLoading = !$event"></delete-button>
                                </el-button-group>
                            </template>
                        </el-table-column>
                    </el-table>
        ...
        <biaya-kabel-form :range_id="range_id" :biaya_kabel_id="biaya_kabel.biaya_kabel_id" @onSuccess="queryServer" @onConflict="handleBiayaKabelConflict">
        </biaya-kabel-form>
    </div>
</template>
...
export default {
        ...
        return {
            ...
            rules: {
                harga_per_meter: [
                    {
                        required:true,
                        message: this.trans('core.validation.required', {field: this.trans('biaya_kabel.form.harga kabel')}),
                        trigger: ['blur', 'change']
                    }
                ]
            }
    ...
    methods: {
        ...
        queryServerBiayaKabel() {
            ...
            axios.get(route('api.company.biayakabel.index'), properties)
                .then(response => {
        ...
        queryServer(customProperties) {
            ...
            axios.get(route('api.company.biayakabel.range.index'), properties)
            .then(response => {
                ...
                if(valid) { 
                    Swal.fire({
                        ...
                        if(result.value) {
                            ...
                            axios.post(route('api.company.biayakabel.update', { biaya_kabel: this.biaya_kabel.biaya_kabel_id }), this.biaya_kabel)
                            .then(response => {
        ...
        biayaKabelTipeChanged() {
            ...
            axios.post(route('api.company.biayakabel.update', {biaya_kabel: this.biaya_kabel.biaya_kabel_id}), properties)
            .catch(err => {
