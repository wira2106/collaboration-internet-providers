<template>
    <bs-modal size="medium" id="modal-biaya-kabel" @onClose="onCancel()">
        ...
        <div class="container">
            <el-form 
                ...
                <div class="col-12">
                    ...
                    >
                        <el-input v-model="biayakabel.panjang_kabel" type="number" size="small">
                ...
                <div class="col-12">
                    ...
                    :rules="rules.biaya"
                    >
                        <input-currency v-model="biayakabel.biaya">
                        </input-currency>
                    </el-form-item>
        ...
        <div slot="footer">
            <el-button type="primary" icon="el-icon-upload" @click="onSubmit('biaya-kabel')" :loading="form_loading">
                {{ trans_button_save }}
            </el-button>
...
export default {
        ...
        return {
            ...
            rules: {
                panjang_kabel: [
                    {
                        required:true, 
                        message: this.trans('core.validation.required', {field: this.trans('biaya_kabel.form.panjang kabel')}), 
                        trigger: ['blur', 'change']
                    }
                ],
                biaya: [
                    {
                        required:true,
                        message: this.trans('core.validation.required', {field: this.trans('biaya_kabel.form.biaya')}),
                        trigger: ['blur', 'change']
                    }
                ]
            }
    ...
    methods: {
                        ...
                        this.form.post(this.getRoute())
                            ...
                            .catch((error) => {
                                ...
                                if(error.response.status === 409) {
                                    this.$emit('onConflict',JSON.parse(error.response.data.message))
                                    return
                                }
                                this.Toast({
                                    icon: "error",
        ...
        getRoute() {
            if(this.range_id) {
                return route('api.company.biayakabel.range.update', {range_biaya_kabel: this.range_id, biaya_kabel: this.biaya_kabel_id})
            }
        ...
        fetchBiayaKabel() {
            ...
            axios.get(this.getRouteBiayaKabel())
            .then(response => {
        ...
        getRouteBiayaKabel() {
            if(this.range_id) {
                return route('api.company.biayakabel.range.find', { range_biaya_kabel: this.range_id })
            }
    ...
    computed: {
        trans_button_save:function() {
            if(this.range_id) return this.trans('core.button.save');
            
            return this.trans('core.button.create');
        },
