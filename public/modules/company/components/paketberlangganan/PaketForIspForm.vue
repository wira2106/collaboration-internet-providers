        ...
        <div class="row page-titles">
            ...
            <div class="col-md-7 align-self-center">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item">
                        <router-link :to="{name :'admin.company.paketberlangganans.index'}">
                            ...
                            <el-form
                                ...
                                <div class="card card-outline-info" style="margin-top: 15px;">
                                    ...
                                    <div class="card-body">
                                            <el-form-item
                                                label="Daftar ISP"
                                                :rules="{required: true, message:'Data Tidak Boleh Kosong',trigger:'blur'}"
                                                prop="isp_id">
                                                <el-select 
...
<script>
    ...
    export default {
        ...
        methods:{
            show(){return this.showSelect = true;},
            getPaket(){
                axios.get(route('api.company.paketforisp.option'))
                .then((response)=>{
                   ...
                   if (valid) {
                       console.log(valid);
                        Swal.fire({
                            ...
                            this.loading = true;
                            if(result.value){
                                this.form.post(route('api.company.paketforisp.store'))
                                .then((response)=>{
                                    this.loading = false;
